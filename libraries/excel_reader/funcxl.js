...
function to_formulae(workbook) {
	...
	workbook.SheetNames.forEach(function(sheetName) {
		var thisSheetLastColumn = "ZZZZ";
		
		if( sheetEndColumns.length > currentSheetNumber )
			thisSheetLastColumn = sheetEndColumns[currentSheetNumber];
		
		//console.log(thisSheetLastColumn);
